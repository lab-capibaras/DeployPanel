    ...
    <div className="relative min-h-screen bg-[#0b0f19] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md z-10">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-white mb-2">{l.welcome}</h1>
          <p className="text-[#CBCDD3]">{l.subtitle}</p>
        </div>
        ...
        <div className="bg-[#0f172a]/60 backdrop-blur-md rounded-2xl border border-[#2F4A67]/30 p-8 shadow-2xl">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-[#0b0f19] text-[#CBCDD3]">{l.or_continue}</span>
            </div>
          </div>

          {/* Social Login */}
          <div className="grid grid-cols-2 gap-4">
            <button type="button" className="flex items-center justify-center px-4 py-3 border border-[#2F4A67]/30 rounded-lg hover:bg-[#0b0f19]/50 transition text-white font-medium">
        ...
        <p className="text-center mt-6 text-[#CBCDD3]">
          {l.no_account}{' '}
          <a href="#" className="text-[#0F2C45] hover:text-[#2F4A67] font-medium transition">{l.sign_up}</a>
        </p>
