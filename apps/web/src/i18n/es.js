const es = {
  ...
  dashboard: {
    ...
    gh_repos_tab:        'Mis Repos',
    gh_orgs_tab:         'Organizaciones',
    gh_connect_hint_full:'Conecta tu cuenta de GitHub para ver repos privados y organizaciones.',
    gh_orgs_loading:     'Cargando organizaciones...',
    gh_orgs_empty:       'No perteneces a ninguna organización',
    gh_orgs_empty_hint:  ' — conecta tu cuenta de GitHub para ver organizaciones privadas',
    gh_orgs_public_repos:(n) => `${n} repos públicos`,
